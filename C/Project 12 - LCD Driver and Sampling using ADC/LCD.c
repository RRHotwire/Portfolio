...
//http://users.ece.utexas.edu/~valvano/EE345L/Labs/Fall2011/lcd4bit.c
//https://github.com/agaelema/LCD16x2_MSP43x/blob/master/lcd16x2_msp43x.c
...
void LCD_OutUFix(uint32_t number) {
    ...
    if(number > 9999){
        ...
        LCD_OutChar(thousands + '0');

        LCD_OutChar('.');

        hundreds = (number % 1000) / 100;
        LCD_OutChar(hundreds + '0');
