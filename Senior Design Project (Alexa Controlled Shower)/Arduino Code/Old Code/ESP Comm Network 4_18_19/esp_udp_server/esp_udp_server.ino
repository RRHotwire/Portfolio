...
<center> <input class ="submit" type="submit" id="OpenHot"  value="Open Hot"></input><br style="line-height:1.75"></center>
</form>

<form method="post" action="/CloseHot">
<center> <input class ="submit" type="submit" id="CloseHot"  value="Close Hot"></input><br style="line-height:1.75"></center> 
</form>

<form method="post" action="/OpenCold">
<center> <input class ="submit" type="submit" id="OpenCold"  value="Open Cold"></input><br style="line-height:1.75"></center>
</form>

<form method="post" action="/CloseCold">
<center> <input class ="submit" type="submit" id="CloseCold"  value="Close Cold"> </input><br style="line-height:1.75"></center>
</form>
...
<center><input class ="submit" id="Forward" onclick="func(this)"  type ="submit" value="Forward">  </input><br style="line-height:1.75"></center>
</form>

<form method="post" action="/Center">
<center><input class ="submit" id="Center" onclick="func(this)"  type ="submit" value="Center"> </input> <br style="line-height:1.75"></center>
</form>

<form method="post" action="/Backward">
<center><input class ="submit" id="Backward" onclick="func(this)"  type ="submit" value="Backward"> </input> <br style="line-height:1.75"></center>
</form>
