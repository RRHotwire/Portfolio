...
//======================================================================
void msgSender(char * msg){
  Serial.println("sending message...");
  udp.beginPacket(ServerIP, 2000);
  udp.write(msg, sizeof(msg)/sizeof(msg[0]));
  udp.endPacket();
...
{
digitalWrite(dir, LOW); //Rotate stepper motor in clock wise direction //change to LOW when on slider
...
{
digitalWrite(dir, HIGH); //Rotate stepper motor in anti clock wise direction ////change to HIGH when on slider
          for( i=1;i<=steps;i++){
          digitalWrite(stepping, HIGH);
